...
const RAJESH_SCRIPT: readonly Exchange[] = [
  ...
  {
    fieldPath: 'hpi.associated.fainting',
    ask: 'Have you blacked out, or felt like you were about to?',
    said: 'no',
    modality: 'choice',
    expect: 'none',
    minutesAgo: 7,
  ...
  {
    fieldPath: 'past_medical.hypertension',
    ask: 'Have you ever been told you have high blood pressure?',
    said: 'Yes, for about ten years',
    modality: 'voice',
    expect: 'recorded',
    expectValue: true,
    minutesAgo: 6,
